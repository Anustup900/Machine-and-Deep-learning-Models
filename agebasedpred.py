...
def get_mov_combined_features():
    ...
    mov_id = layers.data(name='job_id', shape=[1], dtype='int64')
...
def train(use_cuda, params_dirname):
    ...
    feed_order = [
        'user_id', 'gender_id', 'age_id', 'location_id', 'job_id', 'category_id',
        'job_title', 'score'
    ]
                ...
                if batch_id == 20:
                    ...
                    if params_dirname is not None:
                        fluid.io.save_inference_model(params_dirname, [
                            "user_id", "gender_id", "age_id",
                            "job_id", "category_id", "job_title"
