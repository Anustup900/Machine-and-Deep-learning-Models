            ...
            with open(data_out, 'w+') as f:
                for line in open(data_in, 'r'):
                    ...
                    for i in range(len(m_title)-1):
                        ...
                        m_title[i] = paddle.dataset.jobslens.get_job_title_dict()[title]

                    for i in range(len(m_categories)):
                        categories = str(m_categories[i])
                        m_categories[i] = paddle.dataset.jobslens.job_categories()[categories]
